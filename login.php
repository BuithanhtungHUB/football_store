        ...
        <div class="col-xl-10 col-lg-12 col-md-9">
            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6"><img height="578px" width="500px" src="https://i.pinimg.com/originals/18/ba/bd/18babdf983a8fbd43d18aa7485dd52ba.jpg" alt=""></div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="app/View/frontend/forgot-password.html">Forgot Password?</a>
                                </div>
                                <div class="text-center">
                                    <a class="small" href="app/View/frontend/register.html">Create an Account!</a>
                                </div>
                            </div>
                        </div>
                    </div>
